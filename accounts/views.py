...
class EditDetails(generic.UpdateView):
    ...
    UserChangeForm.
    template_name: The name of the template used for rendering the user details
    edit page, set to 'registration/edit_details.html'.
    success_url: The URL to redirect to upon successfully updating the user
    details, utilizing the reverse_lazy method.
    """
...
class ChangePassword(PasswordChangeView):
    ...
    Attributes: form_class: The form class used for changing the user's
    password, which is set to ChangePasswordForm.
    template_name: The name of the template used for rendering the change
    password page, set to 'registration/change_password.html'.
    success_url: The URL to redirect to upon successfully changing the
    password, utilizing the reverse_lazy method with the 'home' URL name.
    """
...
class CreateProfile(generic.CreateView):
    ...
    generic.CreateView class from Django to handle the form creation process
    and template rendering.

    Attributes:
    model: The model associated with the view, UserProfile, which determines
    the model the view interacts with.
    form_class: The form class associated with the view, UserProfileForm,
    which specifies the form used for creating and updating user profiles.
    template_name: The name of the template used for rendering the create
    profile page, set to 'registration/create_profile.html'
    """
    model = UserProfile
...
class UpdateProfile(generic.UpdateView):
    ...
    the model the view interacts with.
    form_class: The form class associated with the view, UserProfileForm,
    which specifies the form used for updating user profiles.
    template_name: The name of the template used for rendering the update
    profile page, set to 'registration/update_profile.html'.

    Methods:
    get_object: Retrieves UserProfile object based on the username provided in
    the URL.
    """
    model = UserProfile
    form_class = UserProfileForm
